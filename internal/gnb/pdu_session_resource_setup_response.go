...
func BuildPDUSessionResourceSetupResponse(opts *PDUSessionResourceSetupResponseOpts) (ngapType.NGAPPDU, error) {
	...
	// builder := &PDUSessionResourceSetupResponseBuilder{pdu, ies}
	...
	for _, pduSession := range opts.PDUSessions {
		...
		respTransf, err := GetPDUSessionResourceSetupResponseTransfer(opts.N3GnbIp, pduSession.GetTeidDownlink(), pduSession.GetQosId())
		if err != nil {

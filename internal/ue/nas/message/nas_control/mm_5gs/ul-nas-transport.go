...
import (
	...
	"github.com/ellanetworks/core-tester/internal/ue/nas/message/nas_control/sm_5gs"
...
func getUlNasTransport_PduSessionEstablishmentRelease(pduSessionId uint8) []byte {
